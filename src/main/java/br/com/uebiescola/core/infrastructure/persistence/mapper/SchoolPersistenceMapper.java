...
public class SchoolPersistenceMapper {
    ...
    public static SchoolEntity toEntity(School domain, String password) {
        ...
        SchoolEntity entity = SchoolEntity.builder()
                ...
                .marketplaceEnabled(domain.getMarketplaceEnabled())
                .marketplaceCommissionPercent(domain.getMarketplaceCommissionPercent())
                .marketplaceCommissionCap(domain.getMarketplaceCommissionCap())
                .marketplaceSettings(domain.getMarketplaceSettings())
    ...
    public static School toDomain(SchoolEntity entity) {
        ...
        return School.builder()
                ...
                .marketplaceEnabled(entity.getMarketplaceEnabled())
                .marketplaceCommissionPercent(entity.getMarketplaceCommissionPercent())
                .marketplaceCommissionCap(entity.getMarketplaceCommissionCap())
                .marketplaceSettings(entity.getMarketplaceSettings())
